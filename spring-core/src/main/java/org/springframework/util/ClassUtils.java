...
public abstract class ClassUtils {
	 ...
	 *	如果没有，获取ClassUtils类的ClassLoader
	 */
	public static ClassLoader getDefaultClassLoader() {
		...
		if (cl == null) {
			// No thread context class loader -> use class loader of this class. --> 没有Thread Context ClassLoader使用 该类的ClassLoader
			cl = ClassUtils.class.getClassLoader();
			if (cl == null) {
				// getClassLoader() returning null indicates the bootstrap ClassLoader
				try {
					cl = ClassLoader.getSystemClassLoader();  //最后使用系统AppClassLoader
				}
				catch (Throwable ex) {
	...
	public static Class<?> forName(String name, ClassLoader classLoader) throws ClassNotFoundException, LinkageError {
		...
		// "java.lang.String[]" style arrays --> 数组类型
		...
		// "[Ljava.lang.String;" style arrays --> 数组类型
