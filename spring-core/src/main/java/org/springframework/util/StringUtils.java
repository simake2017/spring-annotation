...
public abstract class StringUtils {
	...
	private static final String FOLDER_SEPARATOR = "/"; // linux的路径分隔符

	private static final String WINDOWS_FOLDER_SEPARATOR = "\\"; //windows的路径分隔符
	...
	public static String replace(String inString, String oldPattern, String newPattern) {
		...
		int index = inString.indexOf(oldPattern); //存在 \\
		if (index == -1) {
	...
	public static String cleanPath(String path) {
		...
		String pathToUse = replace(path, WINDOWS_FOLDER_SEPARATOR, FOLDER_SEPARATOR); //将windows路径替换成 /
		...
		for (int i = pathArray.length - 1; i >= 0; i--) {
			...
			if (CURRENT_PATH.equals(element)) {
				...
				// classpath:org/spring/../../a.properties
				if (tops > 0) {
		...
		//根据元素中对应的 TOP_PATH数目，在pathElements中添加相应的TOP_PATH数目
