...
/**
 * 在核心容器DefaultListableBeanFactory基础上 增加 XmlBeanDefinitionReader 类，用于解析
 * resource，但是没有ApplicationContext中提供的xml 的解析功能
 *
 */
...
public class XmlBeanFactory extends DefaultListableBeanFactory {
	...
	//定义一个BeanDefinition的reader,	参数是一个BeanDefinition的registry（注册中心）

	// XmlBeanDefinitionReader用于解析

	/*
		使用 XmlBeanFactory 作为 注册中心
