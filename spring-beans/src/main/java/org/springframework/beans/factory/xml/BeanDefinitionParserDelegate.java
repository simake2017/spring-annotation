...
/**
 * 	定义解析各种Element的方法 （w3c dom   中的 Element  ）
 *
 *	定义解析不同的元素
 */
...
public class BeanDefinitionParserDelegate {
	...
	/*
		...
		Delegate  生成 一个 BeanHolder信息

	 */

	public BeanDefinitionHolder parseBeanDefinitionElement(Element ele, BeanDefinition containingBean) {
		String id = ele.getAttribute(ID_ATTRIBUTE);  //获取bean的 id
		String nameAttr = ele.getAttribute(NAME_ATTRIBUTE); // 获取 bean的名字
	...
	public AbstractBeanDefinition parseBeanDefinitionElement(
		...
		if (ele.hasAttribute(CLASS_ATTRIBUTE)) {
			className = ele.getAttribute(CLASS_ATTRIBUTE).trim();  //获取bean对应的 class_attribute属性
		}
	...
	public AbstractBeanDefinition parseBeanDefinitionAttributes(Element ele, String beanName,
		...
		/*
			scope属性 与  singleton属性 冲突 ，只用 scope属性
